namespace Loupedeck.LolePlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.LolePlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.LolePlugin.Resources.Resource.txt`.
